...
const AlertComponent: FC = () => {
  ...
  if(visibility)
   return (
     <section className='py-2 px-5 flex flex-row justify-between items-center rounded-xl bg-gradient text-white select-none'>
      <div className='flex flex-row items-center'>
       <ExclamationCircleIcon className='w-10 h-10' />
       <span className='p-2 ml-3 inline-block align-middle'>
        <h4 className='font-semibold text-[15px]'>Please Complete Your KYC.</h4>
        <h6 className='mt-1 font-normal text-[12px]'>Please follow the instructions in the email to complete account verification. Make sure to check your promotions/spam as well.</h6>
       </span>
      </div>
      <span 
