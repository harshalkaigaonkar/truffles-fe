     ...
     <section className='py-2 px-5 flex flex-row justify-between items-center rounded-xl bg-gradient text-white select-none'>
      <div className='flex flex-row items-center'>
       ...
       <span className='py-1 ml-3 inline-block align-middle'>
        ...
        <h6 className='mt-[.1px] font-normal text-[11px]'>Please follow the instructions in the email to complete account verification. Make sure to check your promotions/spam as well.</h6>
       </span>
      </div>
      <span 
       ...
       {
        crossOver ? (
         <SolidXCircleIcon className='w-6 h-6 text-white' />
        ) : (
